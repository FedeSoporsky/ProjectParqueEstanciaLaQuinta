...
public class PlayerLocationService : MonoBehaviour
{
    ...
    public IEnumerator _StartLocationService()
    {
        ...
        {
            //UNCOMMENT FOR TESTING ON DEVICES.
            //Debug.Log ("Locations is not enabled.");

            //NOTE: If location is not enabled, we initialize the position of the player in Parque Estancia La Quinta's location from Google Maps.
            loc.setLatLon_deg(-31.421712f, -64.512671f);
