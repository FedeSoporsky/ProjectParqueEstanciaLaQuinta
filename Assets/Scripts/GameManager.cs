...
//This part of the class contains the default setup of the GoogleMap' script.
public partial class GameManager : Singleton<GameManager>
{
    ...
    {
        var googleStaticMainMap = mainMap.GetComponent<GoogleStaticMap>();
        if (googleStaticMainMap == null)
        {
            Debug.Log("Failed to get mainMap at GameManager's script.");
        }
        return googleStaticMainMap;
    }
    ...
    IEnumerator Start()
    {
        ...
        Debug.Log("centerMercator has been set.");
...
{
    HashSet<int> _SecretVistas;

    public HashSet<int> SecretVistas
    {
        get { return _SecretVistas; }
        set { _SecretVistas = value; }
    }
}